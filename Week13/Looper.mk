...
#   make -f Looper.mk count            # Count reads for all samples
#   make -f Looper.mk matrix           # Create count matrix
...
all: fastq fastqc align stats bigwig count
	make matrix
...
.PHONY: all fastq fastqc align stats bigwig count matrix vcf merge-vcf annotate